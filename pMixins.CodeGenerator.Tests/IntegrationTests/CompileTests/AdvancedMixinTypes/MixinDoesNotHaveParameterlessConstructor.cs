    ...
    public class MixinDoesNotHaveParameterlessConstructor : GenerateCodeAndCompileTestBase
    {
        protected override string SourceCode
        {
            get
            {
                return
                    @"
                using pMixins.AutoGenerated.Test.Target.Test.MixinWithoutParameterlessConstructor;
                using pMixins.AutoGenerated.Test.Target.Test.MixinWithoutParameterlessConstructorThatIsProtected;
                ...
                namespace Test
                {
                    ...
                    public partial class Target
                    {
                        ...
                        .InitializeMixin()
                        {
                            return new MixinWithoutParameterlessConstructorThatIsProtectedAbstractWrapper
