//----------------------------------------------------------------------- 
// <copyright file="MixinReadonlyDataMembersAreInjectedIntoTarget.cs" company="Copacetic Software"> 
...
{
    [TestFixture]
    public class MixinReadonlyDataMembersAreInjectedIntoTarget : GenerateCodeAndCompileTestBase
    {
            ...
            get
            {
                return
                    @"
                        namespace Test
                        {
                            public class MixinWithReadOnlyDataMembers
                            {
                                public readonly string  DataMember = ""Readonly"";                                
                            }

                            [CopaceticSoftware.pMixins.Attributes.pMixin(
                                Mixin = typeof (Test.MixinWithReadOnlyDataMembers))]
