//----------------------------------------------------------------------- 
// <copyright file="MixinDependencyIsImplementedByTarget.cs" company="Copacetic Software"> 
...
{
    public class MixinDependencyIsImplementedByTarget : GenerateCodeAndCompileTestBase
    {
            ...
            get
            {
                return
                    ...
                    namespace Test{
                        ...
                        public partial class Target : IDependency {
                            public int GetNumber(){ return 0;}
                        }
                    }";
            }
