...
{
    /// <summary>
    /// Generates the members for <see cref="TargetCodeBehindPlan.MixinsClassName"/> inside
    ...
    public class GenerateMixinsClassInTargetCodeBehindMembers : IPipelineStep<TargetLevelCodeGeneratorPipelineState>
    {
        ...
        {
            return
                mixinPlan.CodeGenerationPlan.TargetCodeBehindPlan.GlobalAutoGeneratedContainerClassName
                    .EnsureEndsWith(".") +
                mixinPlan.MixinLevelAutoGeneratedContainerClass
                    .EnsureEndsWith(".") +
