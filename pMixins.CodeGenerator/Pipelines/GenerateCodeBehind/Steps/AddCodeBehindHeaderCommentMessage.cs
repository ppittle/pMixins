...
{
    public class AddCodeBehindHeaderCommentMessage : IPipelineStep<IGenerateCodePipelineState>
    {
        public bool PerformTask(IGenerateCodePipelineState manager)
        {
            ...
            manager.CodeBehindSyntaxTree.AddChild(commentNode, Roles.Comment);
        ...
        private static string FormatHeader(string targetFileName)
        {
            var hostingAssemblyName =
                Assembly.GetAssembly(typeof(AddCodeBehindHeaderCommentMessage)).GetName();
