...
/////////////////////////////////////////*/
    ...
    public partial class MixinDependencySpec : IDependency, IEmptyDependency, IEmptyDependency2
    {
        private class __pMixinAutoGenerated
        {
            public class CopaceticSoftware_pMixin_TheorySandbox_Interceptors_BasicInterceptor_Mixin
            {
                ...
                public sealed class MasterWrapper : MasterWrapperBase
                {
                    ...
                    public MasterWrapper(MixinDependencySpec target)
                    {
                        ...
                        ((IMixinDependency<IDependency>) Mixin).Dependency = target;
                        ((IMixinDependency<IDependency>) Mixin).OnDependencySet();

                        ((IMixinDependency<IEmptyDependency>)Mixin).Dependency = target;
                        ((IMixinDependency<IEmptyDependency>)Mixin).OnDependencySet();

                        ((IMixinDependency<IEmptyDependency2>)Mixin).Dependency = target;
