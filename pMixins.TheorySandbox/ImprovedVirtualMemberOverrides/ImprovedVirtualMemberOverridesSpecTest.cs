...
namespace CopaceticSoftware.pMixins.TheorySandbox.ImprovedVirtualMemberOverrides
{
    ...
    /// </summary>
    public class ImprovedVirtualMemberOverridesSpecTest : SpecTestBase
    {
        private ImprovedVirtualMemberOverridesSpec _spec;

        protected override void Establish_context()
        {
            _spec = new ImprovedVirtualMemberOverridesSpec();
        }
    ...
    public class ChildTest : ImprovedVirtualMemberOverridesSpec
    {
